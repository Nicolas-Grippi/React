...
const products = [
    ...
    },
    {
        ...
        category: 'campera',
        description: 'Talles: XL, L , M, S, XS',
        image: 'https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/d19d18879b2b484ca2dd13df8a00c5d8_9366/Buzo_con_Capucha_ADN_Argentina_con_Cierre_Frontal_24_Azul_IU2143_21_model.jpg'
    }
];
...
async function migrateProductsToFirestore() {
  ...
  try {
    for (const product of products) {
      ...
      console.log(`Producto ${product.title} agregado a Firestore`);
    }
    console.log('Todos los productos han sido migrados a Firestore.');
  } catch (error) {
    console.error('Error migrando productos a Firestore: ', error);
  }
}
